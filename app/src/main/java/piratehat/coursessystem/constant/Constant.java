...
public class Constant {
    ...
    public static final String MANAGER_DELETE_COURSE = IP_ADDRESS+"/manager/course/delete";
    public static final String MANAGER_ADD_COURSE = IP_ADDRESS+"/manager/course/add";
